...
for result in range(1,n_capital_letters+1):
    strong_password=random.choice(capital_letters)
    password +=strong_password
    
for result in range(1,n_small_letters+1):
    strong_password=random.choice(small_letters)    
    password +=strong_password
    
for result in range(1,n_numbers+1)    :
